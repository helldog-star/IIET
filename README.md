...
Official PyTorch implementation of [our EMNLP 2025 main paper](https://aclanthology.org/2025.emnlp-main.453.pdf).
...
### Models
The modeling files in the `models/` folder are implemented based on the original modeling files from the [Transformers](https://github.com/huggingface/transformers) library and are compatible with Transformers 4.44.

### Inference
For autoregressive inference with IIET or PCformer, custom KV cache is required. Please refer to `infer.py` for implementation examples.
